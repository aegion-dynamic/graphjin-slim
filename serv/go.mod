...
require (
	github.com/aegion-dynamic/graphjin-slim/core/v3 v3.0.3
...
require (
	github.com/aegion-dynamic/graphjin-slim/postgres/v3 v3.0.0
	github.com/aegion-dynamic/graphjin-slim/sqlite/v3 v3.0.0
