...
func TestFKColumnRelationNameCollisionUsesTargetTable(t *testing.T) {
	...
	qc, _ := graphql.NewCompiler(schema, graphql.Config{})
...
func TestInvalidCompile1(t *testing.T) {
	qcompile, _ := graphql.NewCompiler(dbs, graphql.Config{})
...
func TestPartitionFilterInjected(t *testing.T) {
	...
	qc, err := graphql.NewCompiler(pSchema, graphql.Config{})
	if err != nil {
		t.Fatal(err)
	}
...
func TestPartitionFilterRequiredInOLAPWhenNoUserFilter(t *testing.T) {
	...
	qc, err := graphql.NewCompiler(pSchema, graphql.Config{AnalyticsMode: true})
	if err != nil {
		t.Fatal(err)
	}
...
func TestPartitionFilterRequiredInOLAPFromImplicitTemporalColumn(t *testing.T) {
	qc, _ := graphql.NewCompiler(dbs, graphql.Config{AnalyticsMode: true})
...
func TestPartitionFilterUnrestrictedBypassesCheckWhenNoColumn(t *testing.T) {
	...
	qc, _ := graphql.NewCompiler(schema, graphql.Config{AnalyticsMode: true})
