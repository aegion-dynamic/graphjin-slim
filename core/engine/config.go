...
// Clone is exported version of clone for cross-package use.
func (c *Config) Clone() *Config { return c.clone() }

// DefaultDatabaseName is exported version of defaultDatabaseName.
func (c *Config) DefaultDatabaseName() string { return c.defaultDatabaseName() }
