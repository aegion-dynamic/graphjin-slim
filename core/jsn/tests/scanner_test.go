...
type Field = jsn.Field

var (
	isJSONNumberStart   = jsn.IsJSONNumberStart
	isJSONNumberPart    = jsn.IsJSONNumberPart
	lookupBytesKeyHash  = jsn.LookupBytesKeyHash
	lookupStringKeyHash = jsn.LookupStringKeyHash
	lookupFieldHash     = jsn.LookupFieldHash
)
