...
const (
	...
	RepairKindNullComparison = runtime.RepairKindNullComparison
	RepairKindAggregateFilter = runtime.RepairKindAggregateFilter
	RepairKindQualifiedRoot  = runtime.RepairKindQualifiedRoot
)
