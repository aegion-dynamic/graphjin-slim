...
require (
	github.com/aegion-dynamic/graphjin-slim/core/v3 v3.33.33
...
require (
	github.com/aegion-dynamic/graphjin-slim/postgres/v3 v3.33.33
	github.com/aegion-dynamic/graphjin-slim/sqlite/v3 v3.33.33
